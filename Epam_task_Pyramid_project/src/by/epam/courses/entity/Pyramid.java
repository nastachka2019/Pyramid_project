...
import by.epam.courses.generator.IdGenerator;
import by.epam.courses.observer.Observable;
import by.epam.courses.observer.Observer;
import by.epam.courses.observer.PyramidEvent;
...
public class Pyramid implements Observable {
    ...
    public boolean equals(Object object) {
        ...
        Pyramid pyramid = (Pyramid) object;           // объявили перемен.,кот. сравн-ем и привели к этому типу обджект.
    ...
    @Override
    public void notifyObserver() {  // уведомляет всех об изменениях
